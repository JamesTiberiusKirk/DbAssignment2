    ...
    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <?php
                            $count = 1;
                            $sql = "SELECT * FROM Product WHERE Type='Desktop' ORDER BY CurrentPrice DESC"; //Change for new DB for type
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<a href="product_Desktops.php?prodID=' . $row['ProductID'] . '" name="buy_btn" class="btn btn-secondary float-right">Buy</a>';
                                    echo '</form>';
